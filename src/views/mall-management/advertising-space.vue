...
export default {
  ...
  data() {
    return {
      ...
      token: getToken(),
      tableKey: 0,
      // list: [{ name: '广告1', id: 1, pid: 1, link: 'www.baidu.com', img: '', status: 2 }, { name: '广告2', id: 2, pid: 2, link: 'www.baidu.com', img: '', status: 1 }, { name: '广告3', id: 3, pid: 3, link: 'www.baidu.com', img: '', status: 1 }],
      list: [],
      total: 0,
      listLoading: true,
      listQuery: {
